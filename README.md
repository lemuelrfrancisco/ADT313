...
| POST   | localhost/movieproject-api/movies/1       | ![[Pasted image 20241022134229.png]]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Authorization | Update using Form (POST)     |
...
| POST       | localhost/movieproject-api/admin/casts   | ![[Pasted image 20241022134525.png]]                                                                                                                                                                                     | Authorization | Create using Form       |
...
| POST       | localhost/movieproject-api/admin/photos   | ![[Pasted image 20241022135009.png]]                                                                                                                                         | Authorization | Create using Form       |
